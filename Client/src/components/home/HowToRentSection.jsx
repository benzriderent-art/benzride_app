...
export default function HowToRentSection() {
  ...
  return (
    <section id="how-to-rent" className="py-24 bg-off-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <Animate className="mb-12 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          ...
          <p className="text-gray-400 text-sm hidden sm:block shrink-0">
            {t('howToRent.steps4')}
          </p>
        </Animate>

        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 border-t border-gray-200 pt-10">
          {STEPS.map((key, i) => (
