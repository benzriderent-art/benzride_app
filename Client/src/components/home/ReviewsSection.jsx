    ...
    <section id="reviews" className="py-24 bg-charcoal">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <Animate className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full px-3 py-1.5 mb-4" style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.12)' }}>
              ...
              <span className="text-xs font-bold text-white/60">{t('reviews.googleBadge')}</span>
            </div>
          ...
          <div className="flex flex-col items-end gap-3 shrink-0 pb-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-heading font-bold text-white">4.9</span>
              <span className="text-white/30 text-sm">· {t('common.reviews200')}</span>
            </div>
            <a
        ...
        <Animate delay={60} className="rounded-2xl p-8 sm:p-10 mb-5" style={{ background: 'rgba(201,162,75,0.08)', border: '1px solid rgba(201,162,75,0.2)' }}>
          <Stars count={featured.rating} size={14} />
          <p className="font-heading text-xl sm:text-2xl text-white leading-[1.6] my-5 italic">
          ...
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-white/40">{featured.origin}</p>
              </div>
            </div>
            <span className="text-[10px] font-bold text-white/30 px-2 py-1 rounded-full" style={{ border: '1px solid rgba(255,255,255,0.15)' }}>
          ...
          {rest.map((review, i) => (
            <Animate key={i} delay={i * 80 + 120}>
              <div className="rounded-2xl p-6 h-full" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
                ...
                <p className="text-sm text-white/60 leading-relaxed my-4 italic">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/35">{review.origin}</p>
                  </div>
                </div>
              </div>
            </Animate>
