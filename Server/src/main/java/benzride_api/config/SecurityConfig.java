    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/bookings/whatsapp").permitAll()
                ...
                .requestMatchers(HttpMethod.POST, "/api/tour-bookings").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/tours/*/images").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/tours/*/images/**").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/api/tour-bookings/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PATCH, "/api/tour-bookings/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/tour-bookings/**").hasRole("ADMIN")
